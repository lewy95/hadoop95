...
import cn.xzxy.yjt.autoIntOut.PeopleRecordWriter;
 ...
 * @param <V>
 */
public class PlayerOutputFormat<K,V> extends FileOutputFormat<K,V> {
    ...
    public RecordWriter<K, V> getRecordWriter(TaskAttemptContext taskAttemptContext)
        ...
        //将输出流传给自定义的写出类
        return new PeopleRecordWriter<K, V>(outputStream,":","[fcBayern]");
    }
}
