...
public class DistinctDriver {
    ...
    public static void main(String[] args) throws IOException,
        ...
        FileInputFormat.setInputPaths(job,new Path("hdfs://192.168.80.128:9000/mr/distinct"));
        //5.2设置结果输出路径,输出目录不能存在
        FileOutputFormat.setOutputPath(job, new Path("hdfs://192.168.80.128:9000/mr/distinct/result"));
